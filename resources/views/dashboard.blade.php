        ...
        <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-neutral-900 dark:text-white mt-1">{{ number_format($kapasitasTersedia) }} / {{ number_format($totalKapasitas) }}</p>
                </div>
            ...
            <div class="mt-3">
                <div class="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-2">
                    <div class="bg-orange-600 h-2 rounded-full" style="width: {{ $totalKapasitas > 0 ? min(($totalTerisi / $totalKapasitas * 100), 100) : 0 }}%"></div>
                </div>
            </div>
        </div>
    </div>
