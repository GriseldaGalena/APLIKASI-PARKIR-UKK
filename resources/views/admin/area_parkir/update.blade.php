<x-layouts.app :title="__('Edit Area Parkir')">
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-6 gap-4">
        <div>
            <h1 class="text-3xl font-bold text-blue-600">Edit Area Parkir</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Perbarui informasi area parkir.
            </p>
        </div>
    ...
    <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
        <form action="{{ route('admin.area-parkir.update', $data) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
