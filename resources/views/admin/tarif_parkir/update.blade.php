<x-layouts.app :title="__('Edit Tarif Parkir')">
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-6 gap-4">
        <div>    
            <h1 class="text-3xl font-bold text-blue-600">Edit Tarif Parkir</h1>
    ...
    <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
        <form action="{{ route('admin.tarif-parkir.update', $tarifParkir) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            {{-- Tombol & Info Terakhir Update --}}
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
