...
class DashboardController extends Controller
{
    public function index(Request $request) {
        ...
        return view('dashboard', compact(
            'user', 'startDate', 'endDate', 'totalKendaraan', 'totalAreaParkir', 'totalKapasitas', 'totalTerisi', 
            'kapasitasTersedia', 'totalTransaksi', 'transaksiMasuk', 'transaksiKeluar', 'totalPendapatan', 'transaksiTerbaru', 
